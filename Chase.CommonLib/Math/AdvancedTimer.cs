...
/// <summary>
/// An advanced timer that can be used to get the remaining time until the next elapse is triggered
/// </summary>
public class AdvancedTimer : System.Timers.Timer
{
    ...
    /// cref="Interruptible"/>. <br/> If called while <seealso cref="IsRunning"/> is <b>true</b> and
    /// <seealso cref="Interruptible"/> is <b>false</b> exception is thrown.
    /// </summary>
    ...
    public new void Start()
    {
        ...
        else if (!Interruptible && IsRunning)
        {
